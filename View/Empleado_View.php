...
<!----------------------------------- Contruccion de regsitro de empleados ----------------------------------->
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="View/Actualizar_Empleado_View.php?id=<?php echo $empleados["ID"]?> & nomb_act=<?php echo $empleados["NOMBRE"]?> & email_act=<?php echo $empleados["EMAIL"]?> & direc_act=<?php echo $empleados["DIRECCION"]?> & tel_act=<?php echo $empleados["TELEFONO"]?> & page=<?php echo $_GET['page']?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
